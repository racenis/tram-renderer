...
project: src_main.o 
	g++ -o renderer -L../tram-sdk/ -static src_main.o -ltramsdk  -lglfw3 -lgdi32  -L../tram-sdk/libraries/binaries/win64/ -lOpenAL32    -lBulletSoftBody -lBulletDynamics -lBulletCollision -lLinearMath       -llua 